...
<div className="w-full flex items-center justify-center">
            {status ? (
              ...
              <p className="text-center mr-6 ml-6 text-grey-700">If you don't see the email, check your spam folder.<br /> If still not recieved, click on resend link.<br />If verified, kindly reload this page.</p>
            )}
          </div>
            <button
              onClick={() => router.push("/")}
